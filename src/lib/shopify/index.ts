...
// Use t3-env for type-safe runtime env var access
const getDomain = () => ensureStartsWith(env.SHOPIFY_STORE_DOMAIN, "https://");
const getEndpoint = () => `${getDomain()}${SHOPIFY_GRAPHQL_API_ENDPOINT}`;
const getKey = () => env.SHOPIFY_STOREFRONT_ACCESS_TOKEN;
