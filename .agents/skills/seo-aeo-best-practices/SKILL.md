...
description: SEO and AEO best practices for metadata, Open Graph, sitemaps, robots.txt, hreflang, JSON-LD structured data, EEAT, and content optimized for search engines and AI answer surfaces. Use this skill when implementing page SEO, technical SEO, adding JSON-LD structured data, schema markup, international SEO, AI-overview readiness, Evaluating content quality using EEAT principles, or improving content for Google, ChatGPT, Perplexity, and similar assistants.
---
